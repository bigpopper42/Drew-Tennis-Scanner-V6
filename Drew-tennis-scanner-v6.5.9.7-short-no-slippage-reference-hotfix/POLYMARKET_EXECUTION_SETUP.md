# Polymarket US Live Execution Setup — Version 6.5.9.7
...
- Order type: market, immediate-or-cancel, with up to three ticks of slippage clamped against the 99¢ backed-price ceiling.
...
For SHORT/NO, `slippageTolerance.currentPrice` is the backed NO price. The complementary YES price is retained separately for market interpretation and diagnostics.
...
The future protective-exit rule is a fixed 40¢ trigger on the backed outcome. It is not active in Version 6.5.9.7.
