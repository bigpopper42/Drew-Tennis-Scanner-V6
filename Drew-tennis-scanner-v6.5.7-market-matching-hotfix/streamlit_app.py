...
st.caption(
    "Version 6.5.7: live tennis scanning, Discord alerts, Railway/Supabase monitoring, and guarded Polymarket US execution with authenticated live-market side and order-book validation."
)
