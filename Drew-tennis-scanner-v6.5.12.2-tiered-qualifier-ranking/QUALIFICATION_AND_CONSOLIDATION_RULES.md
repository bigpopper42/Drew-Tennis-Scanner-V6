# Version 6.5.12.2 Qualification and Consolidation Rules
...
Version 6.5.12.2 retains the second hard confirmation when the most recently completed game is the break that creates the current one-break lead:
