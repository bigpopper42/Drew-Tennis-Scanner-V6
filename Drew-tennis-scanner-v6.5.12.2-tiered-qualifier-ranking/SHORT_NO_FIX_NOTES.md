# SHORT/NO Fix Notes — Version 6.5.12.2
...
Version 6.5.12.2 now uses **20%** entry sizing and an active **30¢** client-side backed-outcome stop-loss. The SHORT/NO entry changes described above remain otherwise unchanged.
