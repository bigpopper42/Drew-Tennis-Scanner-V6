...
5. Confirm startup reports Version `6.5.11` and `Polymarket execution: LIVE`.

## Entry behavior

Version 6.5.11 submits a cash-sized market order equal to exactly **20%** of authenticated balance, limited by buying power. The submitted market-order field remains `cashOrderQty`.
